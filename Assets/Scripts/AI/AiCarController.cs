...
public class AiCarController : MonoBehaviour
{
  ...
  private TransmisionType transmisionType = TransmisionType.Automatic;
  ...
  */
  ...
  private bool shouldSteer; //Needs to be modified
  private bool shouldHandbrake;
  public bool shouldShift;
  private bool shouldReverse; //Needs to be modified
  public bool shouldNitro; //Needs to be modified
  ...
  private float steerContextValue; //Needs to be modified
  public float moveContextValue; //Needs to be modified
  private int gearContextValue;
